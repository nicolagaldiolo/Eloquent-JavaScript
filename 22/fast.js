...
// metodo per connettere un nodo all'altro.
GraphNode.prototype.connect = function(other){
  this.edges.push(other);
  other.edges.push(this);
};

// metodo che mi permette di verificare se i nodi sono connessi.
...
// funzione che mi permette di generare tutto l'albero.
// ogni nodo contiene informazioni sugli altri nodi ad esso associati (grazie al metodo connect).
function treeGraph(depth, branches){ // depth (profondità dell'albero), branches (numero di rami x ciascun livello).
  var graph = [];
...
var springLength = 40; // lunghezza (approssimativa della molla a riposo)
var springStrength = 0.1; // costante di rigidità della molla.

var repulsionStrength = 1500; // costante che definisce la forza di repulsione = tendenza a respingersi fra due o più corpi; (più due oggetti sono vicini più la forza di repulsione è grande, + 2 oggetti sono distanti + la forza di repulsione è bassa).0
